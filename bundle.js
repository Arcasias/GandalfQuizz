...
const { useExternalListener, useState } = owl_1.hooks;
...
Dropdown.template = owl_1.tags.xml `
...
},{"@odoo/owl":7}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const owl_1 = require("@odoo/owl");
...
class Ientcli extends owl_1.Component {
    constructor() {
        super(...arguments);
        this.state = useState({
            answer: null,
    ...
    get endMessage() {
        ...
        let description;
        for (const s of data_1.scoreResult.keys()) {
            if (ratio >= Number(s)) {
                description = data_1.scoreResult.get(s);
                break;
            }
        }
        let topProfile = null;
        for (const profile in game.profiles) {
            if (!topProfile ||
                game.profiles[topProfile] <= game.profiles[profile]) {
                topProfile = profile;
            }
        }
        return {
            ...
            title: data_1.profileResult[topProfile].title,
            description: [
                description,
                data_1.profileResult[topProfile].description,
            ].join(" "),
        };
    }
    get mode() {
        return data_1.modes[this.state.mode];
    }
    get step() {
        if (!this.state.game) {
            return null;
    ...
    switchPhase(phase) {
        const mode = data_1.modes[this.state.mode];
        ...
        switch (phase) {
            ...
            case "quizz": {
                const steps = utils_1.shuffle(mode.quizz.steps).slice(0, MAX_QUESTIONS);
                steps.forEach((step, stepId) => {
                    step.id = stepId;
                    if (step.choices) {
                        const colors = new ColorSet(AVAILABLE_COLORS);
                        const colorDefined = step.choices.filter((c) => c.color);
                        for (const defined of colorDefined) {
                            colors.delete(defined.color);
                        }
                        step.choices = utils_1.shuffle(step.choices).map((c, choiceId) => {
                            const choice = Object.assign({ id: `${stepId}.${choiceId}` }, c);
    ...
    next() {
        ...
        if (this.step.choices) {
            const chosen = this.step.choices.find((c) => c.id === this.state.answer);
            game.score += chosen.expected ? RIGHT : WRONG;
            game.profiles[chosen.profile]++;
        }
        else if (this.step.expected) {
            const correct = utils_1.clean(this.state.answer) === utils_1.clean(this.step.expected);
    ...
    toggleRGB(set) {
        ...
        if (set) {
            this.state.rgb = setTimeout(() => {
                rgbIndex = 0;
                RGB_CLASSES = utils_1.shuffle(RGB_CLASSES);
                this.toggleRGB(true);
            }, 300);
        }
        else {
...
Ientcli.components = { Navbar: Navbar_1.default };
Ientcli.style = owl_1.tags.css `
        body {
            overflow: hidden;
        }
...
Ientcli.template = owl_1.tags.xml `
        <div class="ientcli">
            <Navbar
                ...
                <div class="controls">
                    ...
                    <div class="btn-group">
                        <button t-attf-class="btn btn-{{ RGB('primary') }} rounded-0" t-on-click="notify(TACRU)">
                            <i class="fas fa-stop mr-2"/>Arrêter la ${utils_1.gandalf("music")}
                        </button>
...
exports.default = Ientcli;

},{"../data":4,"../utils":5,"./Navbar":3,"@odoo/owl":7}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const owl_1 = require("@odoo/owl");
const utils_1 = require("../utils");
const Dropdown_1 = require("./Dropdown");
class Navbar extends owl_1.Component {
    constructor() {
        super(...arguments);
        ...
        this.ALT_F4 = "";
        this.HELP = "De l'aide ? T'es teubé ou ça se passe comment ?";
    }
    quit() {
...
Navbar.components = { Dropdown: Dropdown_1.default };
Navbar.template = owl_1.tags.xml `
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">${utils_1.gandalf("quizz")}</a>
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <Dropdown class="nav-link" title="'Mode'" icon="'fas fa-hat-wizard'" direction="'down'">
                        <li class="dropdown-item btn" t-on-click="trigger('change-mode', '${"gandalf"}')">
                            Gandulf
                        </li>
                        <li class="dropdown-item btn" t-on-click="trigger('change-mode', '${"partyhard"}')">
                            Party
                        </li>
                        <li class="dropdown-item btn" t-on-click="trigger('change-mode', '${"chicken"}')">
                            Chicken
                        </li>
                    </Dropdown>
                </li>
                <li class="nav-item">
                    <Dropdown class="nav-link" title="'Musique'" icon="'fas fa-music'" direction="'down'">
                        <li class="dropdown-item btn" t-on-click="trigger('change-music', '${"lotr"}')">
                            Teh Lord of teh Reings
                        </li>
                        <li class="dropdown-item btn" t-on-click="trigger('change-music', '${"sax"}')">
                            Epic Sax Guy
                        </li>
                        <li class="dropdown-item btn" t-on-click="trigger('change-music', '${"unicorn"}')">
                            Flappy Unicorn
                        </li>
...
},{"../utils":5,"./Dropdown":1,"@odoo/owl":7}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("./utils");
...
exports.modes = {
    gandalf: {
        image: "gandalf",
        home: {
            title: `Bienvenue sur le ${utils_1.gandalf("quizz")} !`,
            description: `Le principe est très simple : il te suffit de répondre correctement aux ${utils_1.gandalf("questions")} qui te seront posées et tu seras reconnu comme un vrai vétéran de la Terre du Milieu !`,
            button: `Clique sur Gandalf pour commencer`,
        },
        quizz: {
            title: `C'est parti pour le ${utils_1.gandalf("quizz")} !`,
            steps: gandalfQuestions,
        },
        end: {
            title: `Le ${utils_1.gandalf("quizz")} est terminé !`,
    ...
    partyhard: {
        ...
        home: {
            ...
            description: "Qu'est-ce que tu veux poser comme question là-dessus ?",
...
function updateJusteGandalf() {
    attempts++;
    window.localStorage.setItem("gandalf-quizz-attempts", String(attempts));
    terms = {};
}
exports.updateJusteGandalf = updateJusteGandalf;

},{}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const owl_1 = require("@odoo/owl");
const Ientcli_js_1 = require("./components/Ientcli.js");
const utils_js_1 = require("./utils.js");
owl_1.Component.env = {
    qweb: new owl_1.QWeb({ translateFn: utils_js_1.justeGandalf }),
    _: utils_js_1.justeGandalf,
};
const ientcli = new Ientcli_js_1.default();
ientcli.mount(document.body);

},{"./components/Ientcli.js":2,"./utils.js":5,"@odoo/owl":7}],7:[function(require,module,exports){
'use strict';
